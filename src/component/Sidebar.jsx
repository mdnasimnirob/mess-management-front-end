...
const Sidebar = () => {
    ...
    return (
        ...
        <div className=" ">
            ...
            <div className={` ${open ? "w-16" : "w-52"} mt-[70px]  h-screen bg-gray-100 p-4  dark:bg-gray-800`}>
                ...
                <div className=" overflow-y-auto">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <NavLink to='/profile' className="flex items-center py-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-4 whitespace-nowrap">Inbox</span>
                                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
                            </NavLink>
                        </li>
                        <li>
                            <a href="#" className="flex items-center py-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-4 whitespace-nowrap">Users</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center py-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-4 whitespace-nowrap">Products</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center py-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-4 whitespace-nowrap">Sign In</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center py-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-4 whitespace-nowrap">Sign Up</span>
                            </a>
                        </li>
                    </ul>
                </div>
