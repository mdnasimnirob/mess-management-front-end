...
const Navbar = () => {
    return (
        ...
        <div className="visible lg:hidden md:hidden fixed z-50 w-full h-13 max-w-lg -translate-x-1/2 bg-white shadow-stone-200 shadow-lg border border-gray-200 rounded-none bottom-0 left-1/2 dark:bg-gray-700 dark:border-gray-600">
            <div className="grid grid-cols-5 h-full max-w-lg  mx-auto">
                <NavLink
                    ...
                    type="button"
                    className={({ isActive }) =>
                        `border-none rounded-none btn btn-md inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group ${isActive ? "text-blue-600" : "text-gray-900"
                        }`
                    }
                >
                    <RiDashboardHorizontalFill className="hover:text-black text-2xl" />
                ...
                <NavLink to='/home' data-tooltip-target="tooltip-wallet" type="button" className={({ isActive }) =>
                    ...
                    <RiHome4Fill className="text-2xl hover:text-black" />
                ...
                <div className="flex items-center justify-center">
                    <NavLink to='/question' data-tooltip-target="tooltip-new" type="button" className={({ isActive }) => `border-none  w-12 h-12 inline-flex items-center justify-center font-medium    focus:ring-0 ${isActive ? 'focus:text-blue-600 text-blue-600 dark:focus:ring-blue-800' : ' '} focus:outline-none `}>
                        <BsFillQuestionSquareFill className="text-2xl w-full hover:text-3xl hover:text-black" />
                ...
                <NavLink to='/wallet' data-tooltip-target="tooltip-settings" type="button" className={({ isActive }) =>
                    ...
                    <RiWallet3Fill className="text-2xl hover:text-black" />
                ...
                <NavLink to='profile' data-tooltip-target="tooltip-profile" type="button" className={({ isActive }) =>
                    ...
                    <MdOutlineManageAccounts className="text-3xl hover:text-black " />
