                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <NavLink to='/addMeal' onClick={() => { (setOpen(false)) }} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <MdOutlineSoupKitchen className=" text-xl text-gray-600" />
                        ...
                        <li>
                            <NavLink onClick={() => { (setOpen(false)) }} to='/' className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
